...
const StyledWrapper = styled.div`
  ...
  .logo_container {
    ...
    width: 80px;
    height: 80px;
    background: url('/src/assets/images/LogoNutroos.png') no-repeat center center;
    ...
    <StyledWrapper>
      <form className="form_container" onSubmit={handleSubmit}>
        ...
        <div className="input_container">
          ...
          <svg fill="none" viewBox="0 0 24 24" height={24} width={24} xmlns="https://www.w3.org/2000/svg" className="icon">
        ...
        <div className="input_container">
          ...
          <svg fill="none" viewBox="0 0 24 24" height={24} width={24} xmlns="https://www.w3.org/2000/svg" className="icon">
            ...
            <path strokeLinecap="round" strokeWidth="1.5" stroke="#141B34" d="M6 9V6.5C6 4.01472 8.01472 2 10.5 2C12.9853 2 15 4.01472 15 6.5V9" />
            ...
        ...
        <button title="Sign In" type="submit" className="sign-in_ggl">
          <svg height={18} width={18} viewBox="0 0 32 32" xmlnsXlink="https://www.w3.org/1999/xlink" xmlns="https://www.w3.org/2000/svg">
            <defs>
        ...
        <button title="Sign In" type="submit" className="sign-in_apl">
          <svg preserveAspectRatio="xMidYMid" version="1.1" viewBox="0 0 256 315" height="20px" width="16px" xmlnsXlink="https://www.w3.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
            <g>
