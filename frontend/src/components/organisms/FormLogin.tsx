    ...
    <StyledWrapper>
      <form className="form_container" onSubmit={handleSubmit}>
        ...
        <button title="Sign In" type="submit" className="sign-in_apl">
          <svg preserveAspectRatio="xMidYMid" version="1.1" viewBox="0 0 256 315" height="20px" width="16px" xmlnsXlink="http://www.w3.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
            <g>
