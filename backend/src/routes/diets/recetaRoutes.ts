...
import { handleUploadError, createUploadErrorHandler } from '../../middlewares/uploadMiddleware';
import upload from '../../config/multer';

const router = Router();

router.post('/', authenticateToken, authorizeNutricionista, upload.array('imagenes', 5), createUploadErrorHandler('image'), crearReceta);
...
router.put('/:id', authenticateToken, upload.array('imagenes', 5), createUploadErrorHandler('image'), actualizarReceta);
