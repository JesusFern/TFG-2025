...
export const crearEjercicioValidator = [
  ...
  body('series').isInt({ min: 1, max: 20 }).withMessage('Las series deben ser un número entero entre 1 y 20'),
  body('repeticiones').isInt({ min: 1, max: 100 }).withMessage('Las repeticiones deben ser un número entero entre 1 y 100'),
  body('tiempoDescanso').isInt({ min: 0, max: 600 }).withMessage('El tiempo de descanso debe ser un número entero entre 0 y 600 segundos'),
...
export const actualizarEjercicioValidator = [
  ...
  body('series').optional().isInt({ min: 1, max: 20 }).withMessage('Las series deben ser un número entero entre 1 y 20'),
  body('repeticiones').optional().isInt({ min: 1, max: 100 }).withMessage('Las repeticiones deben ser un número entero entre 1 y 100'),
  body('tiempoDescanso').optional().isInt({ min: 0, max: 600 }).withMessage('El tiempo de descanso debe ser un número entero entre 0 y 600 segundos'),
...
export const crearPlanEntrenamientoValidator = [
  ...
  body('duracionDias').isInt({ min: 1, max: 365 }).withMessage('La duración debe ser un número entero entre 1 y 365 días'),
  body('sesionesPorSemana').isInt({ min: 1, max: 7 }).withMessage('Las sesiones por semana deben ser un número entero entre 1 y 7'),
  ...
  body('publico').isBoolean().withMessage('El campo público debe ser un booleano')
];
...
export const actualizarPlanEntrenamientoValidator = [
  ...
  body('duracionDias').optional().isInt({ min: 1, max: 365 }).withMessage('La duración debe ser un número entero entre 1 y 365 días'),
  body('sesionesPorSemana').optional().isInt({ min: 1, max: 7 }).withMessage('Las sesiones por semana deben ser un número entero entre 1 y 7'),
  ...
  body('publico').optional().isBoolean().withMessage('El campo público debe ser un booleano')
];
...
export const crearSesionValidator = [
  ...
  body('duracion').isInt({ min: 1, max: 480 }).withMessage('La duración debe ser un número entero entre 1 y 480 minutos'),
  ...
  body('ejercicios.*.orden').isInt({ min: 1 }).withMessage('El orden debe ser un número entero mayor que 0'),
  body('ejercicios.*.series').isInt({ min: 1, max: 20 }).withMessage('Las series deben ser un número entero entre 1 y 20'),
  body('ejercicios.*.repeticiones').isInt({ min: 1, max: 100 }).withMessage('Las repeticiones deben ser un número entero entre 1 y 100'),
  body('ejercicios.*.peso').optional().isFloat({ min: 0 }).withMessage('El peso debe ser un número positivo'),
  body('ejercicios.*.tiempoDescanso').isInt({ min: 0, max: 600 }).withMessage('El tiempo de descanso debe ser un número entero entre 0 y 600 segundos'),
  ...
  body('ejercicios.*.opcionesProgresion.aumentarPeso').optional().isBoolean().withMessage('Aumentar peso debe ser un booleano'),
  body('ejercicios.*.opcionesProgresion.masRepeticiones').optional().isBoolean().withMessage('Más repeticiones debe ser un booleano'),
  body('ejercicios.*.opcionesProgresion.mayorIntensidad').optional().isBoolean().withMessage('Mayor intensidad debe ser un booleano')
];
...
export const actualizarSesionValidator = [
  ...
  body('duracion').optional().isInt({ min: 1, max: 480 }).withMessage('La duración debe ser un número entero entre 1 y 480 minutos'),
  ...
  body('ejercicios.*.orden').optional().isInt({ min: 1 }).withMessage('El orden debe ser un número entero mayor que 0'),
  body('ejercicios.*.series').optional().isInt({ min: 1, max: 20 }).withMessage('Las series deben ser un número entero entre 1 y 20'),
  body('ejercicios.*.repeticiones').optional().isInt({ min: 1, max: 100 }).withMessage('Las repeticiones deben ser un número entero entre 1 y 100'),
  body('ejercicios.*.peso').optional().isFloat({ min: 0 }).withMessage('El peso debe ser un número positivo'),
  body('ejercicios.*.tiempoDescanso').optional().isInt({ min: 0, max: 600 }).withMessage('El tiempo de descanso debe ser un número entero entre 0 y 600 segundos'),
  body('ejercicios.*.ejerciciosAlternativos').optional().isArray().withMessage('Los ejercicios alternativos deben ser un array'),
  body('ejercicios.*.ejerciciosAlternativos.*').optional().isMongoId().withMessage('Cada ejercicio alternativo debe tener un ID válido'),
  body('ejercicios.*.opcionesProgresion.aumentarPeso').optional().isBoolean().withMessage('Aumentar peso debe ser un booleano'),
  body('ejercicios.*.opcionesProgresion.masRepeticiones').optional().isBoolean().withMessage('Más repeticiones debe ser un booleano'),
...
export const filtrosEjerciciosValidator = [
  ...
  query('publico').optional().isBoolean().withMessage('El campo público debe ser un booleano')
];
...
export const filtrosPlanesValidator = [
  ...
  query('publico').optional().isBoolean().withMessage('El campo público debe ser un booleano'),
  query('activo').optional().isBoolean().withMessage('El campo activo debe ser un booleano')
];
...
export const filtrosSesionesValidator = [
  ...
  query('completada').optional().isBoolean().withMessage('El campo completada debe ser un booleano')
];
