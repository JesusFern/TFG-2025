...
import archivoRoutes from './routes/chats/archivoRoutes';
...
import userTrackingRoutes from './routes/users/userTrackingRoutes';
...
app.use('/api/chat/archivos', archivoRoutes);
